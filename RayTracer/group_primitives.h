 ...
 *   call the intersect routine. when collision found return the nearest
...
public:
    ...
    /// Constructor this with collection of primitives. The method will use only faces oriented to the given direction
    /// @param primitivesList the collection of primitives
    ...
    /// Set primitives. The method will use only faces oriented to the given direction
    /// @param primitivesList the collection of primitives
    /// @param lightDir direction of light
