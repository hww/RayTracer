		...
		*color = *color + material->ambient + material->emission;
		...
		for (int i = 0; i < numLights; i++) {
			...
			if (Vector::dot(lightRay.dir, normal) < 0) {
				// if light dir in other dirrection then
...
private:
	...
	/// @param halfvec The half vector used for lighting equasion
