...
public:
	...
	/// @param index is the sample's index. For antialysing 1
...
private:
	...
	float pxWidth, pxHeight;	//< One divided by wdth and height
	float centerX, centerY;		//< Screen center position
	float aaTableX[128];		//< Antialysing's pixel coordinates
	float aaTableY[128];		//< Antialysing's pixel coordinates
};
