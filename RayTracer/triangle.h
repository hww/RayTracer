...
/**
 * @brief Cointans three world position and thre bormals normal. Additionaly
 * contans normal for triangle.
 */
...
public:
	...
	/// @result true for sucessful intersection
	...
	/// Test if light ray's direction hit fron face of this triangle
...
private:
	...
	/// Test intersection of this trinagle with given ray.
	/// In case if @param backCull is true then ingore back side 
	/// of triangle
